...
import com.example.start.common.utils.annotation.JsonPathValue;
...
public final class JsonUtils {
    ...
    private static void injectValue(Object instance, Field field, Object value) {
        ...
        try {
            ...
            if (value != null && !$.isEqual("null", value.toString()) && !$.isEqual("[]", value.toString())) {
    ...
    private static Object covert(Class<?> type, Object value) {
        if ($.isEqual(type.getName(), String.class.getName())) {
